...
local options = {
    ...
    guicursor = "i:ver100-blinkon200", -- GUI: settings for cursor shape and blinking
    ...
    showcmd = true, -- show (partial) command somewhere
    ...
    termguicolors = true, -- set term gui colors (most terminals support this) (also needed by bufferline plugin)
